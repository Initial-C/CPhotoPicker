...
- (void)setupCellWithData:(id)data {
    ...
    [[CPhotoDataManager shareInstance] fetchAlbumInfoWithThumbImgSize: CGSizeMake(kAlubmImgViewW, kAlubmImgViewW) albumData: data fetchResult:^(NSDictionary *dataDic) {
